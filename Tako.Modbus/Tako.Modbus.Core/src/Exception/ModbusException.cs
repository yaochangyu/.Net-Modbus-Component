...
// ***********************************************************************
// <copyright file="ModbusException.cs" company="">
...
namespace Tako.Modbus.Core
{
    ...
    public class ModbusException : Exception
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ModbusException" /> class with serialized data.
        /// </summary>
        ...
        private static IEnumerable<ModbusException> ModbusExceptionCollection
        {
            get
            {
                if (s_ModbusExceptionCollection == null)
                {
                    ...
                    s_ModbusExceptionCollection.Add(new ModbusException("ILLEGAL FUNCTION")
                    {
                        Code = 0x01,
                        Description =
                    ...
                    s_ModbusExceptionCollection.Add(new ModbusException("ILLEGAL DATA ADDRESS")
                    {
                        Code = 0x02,
                        Description =
                    ...
                    s_ModbusExceptionCollection.Add(new ModbusException("ILLEGAL DATA VALUE")
                    {
                        Code = 0x03,
                        Description =
                    ...
                    s_ModbusExceptionCollection.Add(new ModbusException("SERVER DEVICE FAILURE")
                    {
                        Code = 0x04,
                        Description =
                            "An unrecoverable error occurred while the serverwas attempting to perform the requested action."
                    });
                    s_ModbusExceptionCollection.Add(new ModbusException("ACKNOWLEDGE")
                    {
                        Code = 0x05,
                        Description =
                    ...
                    s_ModbusExceptionCollection.Add(new ModbusException("SERVER DEVICE BUSY")
                    {
                        Code = 0x06,
                        Description =
                    ...
                    s_ModbusExceptionCollection.Add(new ModbusException("MEMORY PARITY ERROR")
                    {
                        Code = 0x08,
                        Description =
                    ...
                    s_ModbusExceptionCollection.Add(new ModbusException("GATEWAY PATH UNAVAILABLE")
                    {
                        Code = 0x0A,
                        Description =
                    ...
                    s_ModbusExceptionCollection.Add(new ModbusException("GATEWAY TARGET DEVICE FAILED TO RESPOND")
                    {
                        Code = 0x0B,
                        Description =
